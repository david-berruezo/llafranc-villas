...
switch($actual_language) {
    case "es":
        ...
        $word_abrir_servicios = "Servicios incluídos";
        break;
    case "en":
        $word_propiedad = "Property";
        $word_abrir_servicios = "Services included";
        $word_ocultar = "Hide";
        break;
    case "ca":
        $word_propiedad = "Propieatat";
        $word_abrir_servicios = "Serveis inclosos";
        $word_ocultar = "Amagar";
        break;
    case "fr":
        $word_propiedad = "Propriété";
        $word_abrir_servicios = "Prestations incluses";
        $word_ocultar = "Cacher";
        break;
}
                    ...
                    <ul class="ui_kit_checkbox selectable-list">
                        ...
                        <li>
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="customCheck10"><?php echo ucfirst($newtext); ?></label>
                        ...
                        <li>
                            <div class="custom-control custom-checkbox">
                                ...
                                ?>
                                <label class="custom-control-label" for="customCheck3"><?php echo ucfirst($newtext); ?></label>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="ui_kit_checkbox selectable-list">
                        <li>
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="customCheck2"><?php echo ucfirst($service_wifi->text_title); ?></label>
                            </div>
                        </li>
                    ...
                    <ul class="apeartment_area_list mb0">
                        ...
                        <li class="list-inline-item">
                            <div class="candidate_revew_select">
                                <div class="dropdown bootstrap-select w100 show-tick"><select class="selectpicker w100 show-tick" name="number_aseos" id="number_aseos" tabindex="-98">
                                        <option>Baños</option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        ...
                                        <option>7</option>
                                        <option>8</option>
                                    </select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="button" data-id="number_aseos" title="Baños"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Baños</div></div> </div></button><div class="dropdown-menu " role="combobox"><div class="inner show" role="listbox" aria-expanded="false" tabindex="-1"><ul class="dropdown-menu inner show"></ul></div></div></div>
                            </div>
                        </li>

                        <li class="list-inline-item">
                            <div class="candidate_revew_select">
                                <div class="dropdown bootstrap-select w100 show-tick"><select class="selectpicker w100 show-tick" name="number_habitaciones" id="number_habitaciones" tabindex="-98">
                                        ...
                                        <option>7</option>
                                        <option>8</option>
                                    </select><button type="button" class="btn dropdown-toggle btn-light" data-toggle="dropdown" role="button" data-id="number_habitaciones" title="Habitaciones"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Habitaciones</div></div> </div></button><div class="dropdown-menu " role="combobox"><div class="inner show" role="listbox" aria-expanded="false" tabindex="-1"><ul class="dropdown-menu inner show"></ul></div></div></div>
                            </div>
                        </li>
