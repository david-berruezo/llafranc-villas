...
category_values: Todos los tipos
...
if (!function_exists('wpestate_ajax_filter_listings')):
    ...
    function wpestate_ajax_filter_listings()
    {
        ...
        if (isset($_POST['services']) && trim($_POST['services']) != esc_html__('All Areas', 'wprentals') && trim($_POST['services']) != 'All Areas' && $_POST['services'] && trim($_POST['services']) != 'all') {
            $taxarea[] = sanitize_title(wp_kses($_POST['services'], $allowed_html));
