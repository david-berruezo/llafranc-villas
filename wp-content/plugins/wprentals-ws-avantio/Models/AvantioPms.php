...
class AvantioPms{
    ...
    private $debug = false;
    //const WEBSERVICE_USER = 'universalholidaycentre';
    //const WEBSERVICE_PWD = 'univ823centre';
    ...
    public function setClientsCredentials($clientsCredentials)
    {
        ...
        if(!$clientsCredentials){
            $this->clientsCredentials = array(
                "universal" => array(
                    "WEBSERVICE_USER" =>  'universalholidaycentre',
                    "Password" =>  "univ823centre"
                ),
                "home_sweet_home_villas" => array(
                    "WEBSERVICE_USER" =>  'home_sweet_home',
                    "Password" =>  "pWZP6HGYgCWxg6vF"
                ),
                "test" => array(
                ...
                "portvillas" => array(
                    "WEBSERVICE_USER" =>  "GAe76f7c6d10",
                    "Password" =>  "321b589a65f4"
                ),
            );
        }else{
