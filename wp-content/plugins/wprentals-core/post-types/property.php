...
////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    register_taxonomy('property_service_piscina', 'estate_property', array(
            'labels' => array(
                'name'              => esc_html__( 'Property Piscina','wprentals-core'),
                'add_new_item'      => esc_html__( 'Add New Piscina','wprentals-core'),
                'new_item_name'     => esc_html__( 'New Piscina','wprentals-core')
            ),
            'hierarchical'  => true,
            'query_var'     => true,
            'rewrite'       => array( 'slug' =>$slug )
...
function wpestate_listing_details_specific_box($post) {
    ...
    $items = array(
        ...
        array(
            'name'  =>  'property_size_parcela',
            'label' => esc_html__('Property Size parcela','wprentals-core').' '.esc_html($measure_sys),
            'type'  => 'input',
        ),
        array(
            'name'  =>  'property_rooms',
        ...
        array(
            'name'  =>  'property_aseos',
            'label' => esc_html__('Property Aseos','wprentals-core'),
            'type'  => 'input',
        ),

        array(
            'name'  =>  'property_bathrooms_banera',
            'label' => esc_html__('Property Baños Bañera','wprentals-core'),
            'type'  => 'input',
        ),

        array(
            'name'  =>  'property_bathrooms_ducha',
            'label' => esc_html__('Property Baños Ducha','wprentals-core'),
            'type'  => 'input',
        ),
