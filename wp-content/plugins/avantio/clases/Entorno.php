...
class Entorno
{
    ...
    public function insertAccomodations($xml,$avantio_credentials)
    {
        ...
        foreach ($xml->Accommodation as $accommodation) {
            ...
            if ($counter_property < 10) {
                ...
                //echo "el identificador es: ".$id."<br>";
                ...
                if (get_post_status($id)) {
                    ...
                    */
                    ...
                    foreach($my_post_translation as $id){
                        //echo "el id es: ".$id."<br>";
                        $this->guardar_entorno($taxonomy_name, $id, $avantio_credentials, $accommodation, $lang_property);
                    }
    ...
    private function guardar_entorno($taxonomy_name, $post_id, $avantio_credentials, $accommodation, $lang)
    {
